...
Hereda de la clase Persona, por lo que reutiliza atributos como nombre,
edad y matrícula.
...
La clase almacena información propia del estudiante, como su promedio,
su inscripción y el curso que se le asigna dentro del sistema.

También implementa el método obtenerResumen(), que viene de la clase Persona.
Esto permite que un objeto Estudiante pueda ser tratado como Persona usando
polimorfismo, pero mostrando su información específica como estudiante.
*/
